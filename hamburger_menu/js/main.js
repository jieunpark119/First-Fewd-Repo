...
// 2. on clicking of the close button in the nav, 
//hide the nav by animating it's left value back to 100%
...
// 3. on resizing of the browser, 
//we want to reset any styles set if we are back on desktop). 
